 ...
 */
public class Axes extends WeaponAbstract {

  /**
   * Construct Axes object.
   *
   * @param damage of Axes weapon.
   * @Throws Null value checks.
   */
  public Axes(int damage) {
    this.damage = damage;
    checkInvalidRange();
  }

  private void checkInvalidRange() {
    if (damage > 11 || damage < 5) {
  ...
  public int compareTo(Weapons o) {
    if (o instanceof WeaponAbstract) {
      ...
      return obj.compareAxes(this);
    }
    return 0;
  }

  /**
   * Used to get String representation of Axe.
   *
   * @return Axe object String.
   */
