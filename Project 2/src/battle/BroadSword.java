...
/**
 * A weapon type subclass used for holding the weapon Broad Sword.
 */
public class BroadSword extends WeaponAbstract {

  /**
   * Construct Broad Sword object.
   *
   * @param damage of Broad Sword weapon.
   * @Throws Invalid Range value checks.
   */
  public BroadSword(int damage) {
    this.damage = damage;
    checkInvalidRange();
  }

  private void checkInvalidRange() {
    if (damage > 10 || damage < 6) {
  ...
  public int compareTo(Weapons o) {
    if (o instanceof WeaponAbstract) {
      ...
      return obj.compareBroadSword(this);
    }
    return 0;
  }

  /**
   * Used to get String representation of Broad Sword.
   *
   * @return Broad Sword object String.
   */
