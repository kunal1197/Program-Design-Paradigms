...
/**
 * The mock implementation of the Dungeon interface with the seed set to 42, so that it becomes
 * deterministic and testable.
 *
 */
public class MockDungeonImpl implements Dungeon {
  ...
  /**
   * This is the constructor for the MockDungeonImpl class.
   *
   ...
   */
  public MockDungeonImpl(int sizeLength, int sizeBreadth, int interconnectivity, boolean wrapping,
                     int treasurePercent) {
    MockDungeonImpl.sizeLength = sizeLength;
    MockDungeonImpl.sizeBreadth = sizeBreadth;
